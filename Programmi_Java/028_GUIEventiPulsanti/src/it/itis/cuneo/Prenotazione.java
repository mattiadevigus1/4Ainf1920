...
public class Prenotazione {
    ...
    {
        return this.cognome + GUI.separator + this.nome + GUI.separator +
                this.telefono + GUI.separator + this.cittaPartenza + GUI.separator + this.cittaDestinazione + GUI.separator + this.data + "\r\n" ;
    }
}
